...
loadTest.requestAtInterval = function () {
  var wrappedRequest = hl.wrapCallback(request[loadTest.defaultOptions.requestMethod.toString().toLowerCase()]);
  var successes = 0;
...
loadTest.buildUrl = function() {
  ...
  console.log('>> ['+ loadTest.defaultOptions.requestMethod +'] Url: ' + url);
  return url;
};
